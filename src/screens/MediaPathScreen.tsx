...
const ORANGE_DARK  = '#FF5E36';
const ORANGE_LIGHT = '#CC3B14';

// ─── DATA ────────────────────────────────────────────────────────────────────

const WHY_OPTIONS = [
  { id: 'story',   text: 'I love storytelling, writing & journalism' },
  { id: 'video',   text: 'I want to produce videos & digital media' },
  { id: 'anchor',  text: 'I aspire to be a news anchor / host' },
  { id: 'pr',      text: 'I want to work in Public Relations & PR' },
  { id: 'impact',  text: 'I want to shape public opinion & truth' },
  { id: 'explore', text: 'I am exploring media & communication' },
];

const WHAT_CARDS = [
  { icon: 'newspaper',             label: 'Journalism & News' },
  { icon: 'video-wireless-outline',label: 'Digital Content' },
  { icon: 'bullhorn-outline',      label: 'Public Relations' },
  { icon: 'camcorder',             label: 'Film Production' },
  { icon: 'microphone-variant',    label: 'Broadcasting & Podcast' },
  { icon: 'account-voice',         label: 'Corporate Comm' },
];

const CHECKLIST_Q = [
  'Do you enjoy expressing ideas clearly through writing or video speaking?',
  'Are you curious about current affairs, news, and societal stories?',
  'Can you ask insightful questions and research facts objectively?',
  'Do you enjoy using cameras, video editing software, or podcasts?',
  'Are you confident interacting with diverse people and interviewing public figures?',
  'Are you willing to work in fast-paced newsrooms or studio environments?',
];

const PERSONALITY = [
  { skill: 'Clear Communication',icon: 'microphone-variant',   why: 'Articulate complex stories and news reporting clearly across media platforms.' },
  { skill: 'Investigative Curiosity',icon: 'magnify',          why: 'Uncover facts, verify sources, and report objective truth to the public.' },
  { skill: 'Digital Agility',   icon: 'laptop-chromebook',     why: 'Master video editing (Premiere/DaVinci), SEO, and social distribution.' },
  { skill: 'Storytelling Vision',icon: 'feather',              why: 'Craft captivating narratives, headlines, and documentary structures.' },
  { skill: 'Public Confidence', icon: 'account-voice',         why: 'Present confidently on-camera, live streams, and public press briefings.' },
  { skill: 'Deadline Stamina',  icon: 'clock-fast',            why: 'Deliver breaking news stories under tight press-time pressure.' },
];
...
const CHECKPOINTS = [
  {
    ...
    icon: 'school-outline',
    detail: 'Build strong reading, writing, English vocabulary, and general awareness during Class 10.',
  },
  {
    id: 2, label: 'Choose Class 11 & 12 (Any Stream)',
    icon: 'book-outline',
    detail: 'Arts/Humanities, Commerce, or Science streams are all 100% eligible for Mass Communication degrees.',
    sub: ['Arts / Humanities', 'Commerce', 'Science'],
    note: '✅ Focus on developing public speaking and article writing skills.',
  },
  {
    id: 3, label: 'Prepare for Mass Comm Entrance Exams',
    icon: 'sparkles-outline',
    detail: 'Prepare for national media university entrance tests evaluating general knowledge and creative writing.',
    sub: ['IIMC Entrance', 'Jamia Millia Entrance', 'CUET BJMC', 'SIMC SET Exam'],
  },
  {
    id: 4, label: "Bachelor's Degree in Mass Comm (BJMC / BA)",
    icon: 'medal-outline',
    detail: 'Enroll in a professional 3-year Mass Communication degree.',
    degrees: [
      { name: 'BA Journalism & Mass Comm (BJMC)', dur: '3 yrs', subjects: 'Print Journalism, TV Reporting, Media Laws, PR, Advertising', careers: 'News Reporter, Sub-Editor, PR Executive' },
      { name: 'B.Sc Electronic Media', dur: '3 yrs', subjects: 'Camera Ops, Video Editing, Studio Production, Sound Design', careers: 'Video Producer, Camera Operator, Sound Engineer' },
      { name: 'BA Digital Media & Communication', dur: '3 yrs', subjects: 'Digital Strategy, SEO, Social Media Marketing, Analytics', careers: 'Digital Content Lead, Social Media Manager' },
      { name: 'PG Diploma in Journalism (IIMC / ACJ)', dur: '1 yr', subjects: 'Investigative Reporting, Broadcast Tech, Editing', careers: 'Senior News Anchor, Special Correspondent' },
    ],
  },
  {
    id: 5, label: 'Media House & Studio Internships',
    icon: 'briefcase-outline',
    detail: 'Undergo mandatory 2-4 month internships at TV news channels, digital outlets, or PR agencies.',
  },
  {
    id: 6, label: 'Bylines & Showreel Portfolio',
    icon: 'ribbon-outline',
    detail: 'Publish investigative articles, produce video packages, and curate a professional showreel.',
  },
  {
    id: 7, label: 'Media & Corporate Recruitment',
    icon: 'briefcase-check-outline',
    detail: 'Join premier news organizations, OTT platforms, production houses, or corporate PR firms.',
    companies: ['NDTV', 'Times Network', 'The Hindu', 'Ogilvy PR', 'Netflix India', 'Edelman PR'],
  },
  {
    id: 8, label: 'Career Growth to Editor-in-Chief',
    icon: 'trending-up',
    detail: 'Ascend to lead newsrooms, executive production, or chief communications officer.',
    growth: ['Reporter / Trainee', 'Senior Correspondent', 'Bureau Chief / Producer', 'Executive Editor', 'Editor-in-Chief / CCO'],
  },
];

const SKILLS = [
  { icon: 'newspaper',                  skill: 'Journalistic Writing' },
  { icon: 'camcorder',                  skill: 'Camera & Video Editing' },
  { icon: 'microphone-variant',         skill: 'Broadcast Anchoring' },
  { icon: 'bullhorn-outline',           skill: 'Public Relations (PR)' },
  { icon: 'web',                         skill: 'Digital Content & SEO' },
  { icon: 'feather',                    skill: 'Copywriting & Scripting' },
  { icon: 'waveform',                    skill: 'Audio & Podcast Engineering' },
  { icon: 'shield-search',              skill: 'Fact Checking & Verification' },
];

const CAREERS = [
  { role: 'Broadcast Journalist',   icon: 'newspaper',            what: 'Reports live news stories, conducts field interviews, and presents breaking stories.', skills: 'Reporting, Live Telecast, Interviewing' },
  { role: 'Video Producer',         icon: 'camcorder',            what: 'Directs, shoots, and edits video documentaries, news packages, and digital shows.', skills: 'Premiere Pro, Storyboarding, Lighting' },
  { role: 'PR Specialist',          icon: 'bullhorn-outline',     what: 'Manages corporate brand reputation, press releases, and media relations.', skills: 'Press Releases, Crisis Comm, Media Outreach' },
  { role: 'Digital Content Lead',   icon: 'video-wireless-outline',what: 'Curates viral social content, manages media channels, and drives audience growth.', skills: 'SEO, Social Strategy, Video Analytics' },
  { role: 'News Anchor',            icon: 'microphone-variant',   what: 'Hosts live studio prime-time debates, news bulletins, and special broadcasts.', skills: 'Teleprompter, Telecast Focus, Voice Modulation' },
  { role: 'Advertising Copywriter', icon: 'feather',              what: 'Writes iconic brand slogans, TV commercial scripts, and digital ad campaigns.', skills: 'Creative Writing, Concepting, Brand Voice' },
];

const CHALLENGES = [
  { icon: 'clock-alert-outline',        title: '24/7 News Cycle',           desc: 'Breaking news requires unexpected travel and round-the-clock availability.' },
  { icon: 'eye-alert-outline',          title: 'Public & Press Scrutiny',   desc: 'Journalism involves public accountability and handling critical feedback.' },
  { icon: 'speedometer',                title: 'High Turnaround Speed',     desc: 'Filing stories before press deadlines demands calm speed and accuracy.' },
];

const COLLEGES = [
  { name: 'IIMC New Delhi',      city: 'New Delhi', desc: 'India’s flagship premier autonomous institute for journalism & mass comm.' },
  { name: 'Jamia Millia Islamia', city: 'New Delhi', desc: 'World-renowned AJK Mass Communication Research Centre for TV & Film.' },
  { name: 'Asian College of Journalism', city: 'Chennai', desc: 'Gold standard post-graduate journalism academy with 100% media placement.' },
  { name: 'SIMC Pune',           city: 'Pune',      desc: 'Symbiosis flagship institute for advertising, PR, and media management.' },
  { name: 'Xavier Inst of Comm',  city: 'Mumbai',    desc: 'Top media school in Mumbai with direct industry veteran faculty.' },
  { name: 'Christ University',   city: 'Bengaluru', desc: 'Premier undergraduate BJMC program focused on digital journalism & TV.' },
];

const SALARY_TIERS = [
  { level: 'Trainee Reporter / Executive', range: '₹3.5–5.5 LPA' },
  { level: 'Senior Correspondent / Producer', range: '₹6–11 LPA' },
  { level: 'Bureau Chief / PR Lead',    range: '₹12–20 LPA' },
  { level: 'Executive Editor / Anchor', range: '₹22–40 LPA' },
  { level: 'Editor-in-Chief / CCO',     range: '₹50+ LPA' },
];

const SUCCESS_TIPS = [
  'Read national and international newspapers daily to sharpen current affairs awareness.',
  'Write regularly for school magazines, personal blogs, or campus newspapers.',
  'Master video editing tools (Adobe Premiere Pro, Final Cut Pro) and camera basics.',
  'Practice clear on-camera speech delivery and voice modulation.',
  'Build a digital portfolio reel of written articles, videos, or podcasts.',
  'Understand digital SEO, analytics, and social media distribution tools.',
  'Network actively with senior journalists and media professionals on LinkedIn and Twitter.',
];
...
const MediaPathScreen = ({ navigation }: any) => {
  ...
  useEffect(() => {
    const saveSector = async () => {
      try {
        await AsyncStorage.setItem('activeSector', 'MEDIA');
      } catch (_) {}
    };
    saveSector();
  }, []);
  ...
  return (
    <SafeAreaView style={[s.root, { backgroundColor: bg }]}>
      ...
      <View style={s.navWrap}>
        <TopNavBar title="Media & Journalism Career Guide" />
      ...
      >
        ...
        >
          ...
          >
            ...
            <MaterialCommunityIcons name="newspaper" size={68} color={C} />
          </LinearGradient>

          <Text style={[s.heroTitle, { color: txt }]}>Media & Journalism Career Roadmap</Text>
          <Text style={[s.heroSub, { color: sub }]}>
            Master Journalism, Digital Content Production, Broadcasting, Public Relations, and Film after Class 10.
          </Text>
        ...
        <Section title="Before We Begin..." color={C} textColor={txt}>
          <Text style={[s.sectionSub, { color: sub }]}>
            Let's evaluate your passion for journalism, digital media, and storytelling.
          </Text>
          <GlassCard bg={card} border={bdr}>
            <Text style={[s.questionLabel, { color: txt }]}>💬 Why choose Media & Journalism?</Text>
            ...
            {whySelected.length > 0 && (
              ...
              >
                ...
                <Text style={[s.feedbackTxt, { color: isDark ? '#FFF' : '#005C5C' }]}>
                  {'  '}Awesome! Media and Mass Communication give you a powerful voice to inform, inspire, and shape modern society.
                </Text>
              </LinearGradient>
            )}
          </GlassCard>
        ...
        {/* SECTION 3 – WHAT IS MEDIA? */}
        <Section title="What is Media & Mass Comm?" color={C} textColor={txt}>
          <Text style={[s.sectionSub, { color: sub }]}>
            Media & Mass Communication connects global audiences through journalism, television, broadcasting, digital media, and strategic PR.
          </Text>
        ...
        {/* SECTION 4 – IS MEDIA RIGHT FOR YOU? */}
        <Section title="Is Media Right For You?" color={C} textColor={txt}>
          <GlassCard bg={card} border={bdr}>
            ...
            {answered === 6 && (
              ...
              >
                ...
                <Text style={[s.resultTxt, { color: txt }]}>
                  {' '}{yesCount >= 4
                    ? '🎉 You have strong communication and storytelling instincts ready for media!'
                    : '💪 Media writing and digital production skills can be honed through practice.'}
                </Text>
              </LinearGradient>
            )}
          </GlassCard>
        ...
        <Section title="Personality Match" color={C} textColor={txt}>
          <Text style={[s.sectionSub, { color: sub }]}>Key traits that excel in media & communications:</Text>
        ...
        <Section title="Challenges You Should Know" color={C} textColor={txt}>
          <Text style={[s.sectionSub, { color: sub }]}>Realities of a Media & Journalism career:</Text>
          {CHALLENGES.map((ch, i) => (
        ...
        <Section title="Top Media Institutes" color={C} textColor={txt}>
          {COLLEGES.map((col, i) => (
        ...
        <Section title="Salary Overview" color={C} textColor={txt}>
          <GlassCard bg={card} border={bdr}>
            ...
            <Text style={[s.salaryNote, { color: sub }]}>
              * Salaries grow rapidly for top news anchors, investigative editors, and senior PR leads.
            </Text>
          </GlassCard>
        </Section>
        ...
        <View style={[s.sectionWrap, { marginBottom: 50 }]}>
          ...
          >
            ...
            <Text style={[s.motTitle, { color: txt }]}>
              Inform, Inspire, and Shape The Story of Tomorrow
            </Text>
            <Text style={[s.motBody, { color: sub }]}>
              Journalism and media hold the power to uncover truth, build brands, and inspire millions. Master storytelling and step into the media spotlight.
            </Text>
            <TouchableOpacity
